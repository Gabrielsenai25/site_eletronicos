const sheetURL='https://docs.google.com/spreadsheets/d/e/2PACX-1vSrwkz8odoSfHsyeCtbOcnAejPuSh5_JET4HucsqAPbHtkKtSU6ysAukDVVqgCHMsCHHglXrffBbpLe/pub?gid=0&single=true&output=csv';
...
async function carregarDados() {
  try {
    ...
    dados.forEach((linha) => {
      ...
      botao.target = '_blank';
      botao.className = 'mt-5 inline-block bg-blue-500 text-white font-semibold py-2 px-10 rounded hover:bg-blue-800';
